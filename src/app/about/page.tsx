        ...
        <div className="row">
          <div className="col-lg-7 mx-auto">
            <div className="content" data-aos="fade-up">
              ...
              <div className="expertise-section mb-5">
                <h3 className="heading3">Areas of Expertise</h3>
                <ul className="qualification-list">
                  <li>
                    <h5>International Arbitration</h5>
                    <ul>
                      <li>Commercial Arbitration</li>
                      <li>Investment Treaty Arbitration</li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>Public Law Litigation</li>
                      <li>Constitutional Law</li>
                    </ul>
                  </li>
                  <li>
                    <h5>Corporate Law & Technology</h5>
                    <ul>
                      <li>Tech Startup Advisory</li>
